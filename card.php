                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <div class="container-fluid pt-3 rounded-0 p-3 bg-light text-right">
                            ...
                            <button type="button" class="btn btn-lg btn-success rounded-0" onclick="addProduct('<?= $row['ProduktName'] ?>')" data-select="btn_warenkorb">
                            ...
                            <div class="input-group mb-3" data-select="btn_g_sum">
                                ...
                                <button class="btn btn-success rounded-0" type="button" id="button-addon2" onclick="addCart('<?= $row['ProduktName'] ?>');">
